...
**Librerie ESP32 per auto-update da GitHub**:
1. **esp_ghota**: check GitHub releases, SemVer, rollback support
2. **ESP32-OTA-Pull**: JSON version check, auto-download
3. **esp32FOTA**: JSON-based, web server o GitHub
4. **OTA_basic**: check al boot, auto-update se newer
